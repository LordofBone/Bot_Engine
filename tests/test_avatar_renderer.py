import unittest
from rendering.avatar_renderer import ModelRendererProcess, ModelRenderer
import time
...
class TestModelRendererProcess(unittest.TestCase):
    ...
    def test4_combined_movements(self):
